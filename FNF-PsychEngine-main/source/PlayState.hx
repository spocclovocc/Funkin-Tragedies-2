...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'hospital': //Week 7
				var bg:BGSprite = new BGSprite('hospital', -600, -200, 0.9, 0.9);
				add(bg);
				
			case 'purgatory': //Week 8
				var bg:BGSprite = new BGSprite('purgatory', -600, -200, 0.9, 0.9);
				add(bg);

			case 'purgatory2': //Week 9
				var bg:BGSprite = new BGSprite('purgatory2', -600, -200, 0.9, 0.9);
				add(bg);
		}
